    ...
    data.students.forEach(student => {
        student.subjects.forEach(sub => {
            ...
            classAveragesMap.set(sub.subjectName, {
                total: existing.total + sub.marks,
                ...
                <CardContent className="space-y-6">
                    <div className="max-w-md">
                        ...
                        <Select value={selectedStudentRoll} onValueChange={setSelectedStudentRoll}>
                            <SelectTrigger>
                                <SelectValue placeholder="Search by Roll Number or Name" />
                            </SelectTrigger>
                            ...
                            <div className="h-[400px] w-full">
                                <ResponsiveContainer width="100%" height="100%">
                                    <BarChart data={comparisonData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                                        ...
                                        <Bar dataKey="studentMarks" name={`${selectedStudent.name}'s Marks`} fill="hsl(var(--primary))" radius={[4, 4, 0, 0]} />
