  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (username === 'superadmin' && password === 'superadmin123') {
        ...
        toast.error('Invalid admin credentials. Try username: superadmin, password: superadmin123');
      }
      setIsLoading(false);
    }, 1000);
  };
          ...
          <div className="glass-card p-8 rounded-xl animate-scale-in">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-sm text-center text-muted-foreground mt-4 p-4 bg-secondary/30 rounded-lg">
                ...
                <p>Username: <span className="font-semibold text-foreground">superadmin</span></p>
                <p>Password: <span className="font-semibold text-foreground">superadmin123</span></p>
              </div>
            </form>
          </div>
        </div>
