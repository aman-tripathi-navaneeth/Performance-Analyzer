...
const UploadPage = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Clear cache to ensure fresh data on dashboard
        cacheManager.invalidateAfterUpload();
  ...
  // Navigate to dashboard with force refresh
  const goToDashboard = () => {
    ...
    // Force a page refresh after navigation to ensure fresh data
    setTimeout(() => {
      ...
      <div className="upload-container">
        ...
        <div className="upload-header">
          ...
          <p className="upload-subtitle">
            Upload Excel or CSV files containing student assessment data to
            analyze performance
          </p>
        </div>
            ...
            <div className="success-content">
              ...
              <p className="success-message">
                ...
                {uploadResult.data?.processed_records && (
                  <span>
                    {" "}
                    {uploadResult.data.processed_records} records were imported.
                  </span>
                )}
              </p>
              <div className="success-actions">
                ...
                <button className="btn btn-secondary" onClick={goToStudents}>
                  View Students
                </button>
          ...
          <div className="instructions-content">
            <div className="instruction-section">
              ...
              <ul className="instruction-list">
                ...
                <li>
                  <strong>Student ID/Roll Number</strong> - Unique identifier
                  (e.g., 21A91A0501)
                </li>
                <li>
                  <strong>Score/Marks</strong> - Assessment score or percentage
                </li>
              </ul>
            </div>
            ...
            <div className="instruction-section">
              ...
              <ul className="instruction-list">
                ...
                <li>
                  <strong>Grade</strong> - Letter grade (A, B, C, etc.)
                </li>
              </ul>
            </div>
            ...
            <div className="instruction-section">
              ...
              <ul className="instruction-list">
                <li>
                  <strong>Years:</strong> 1st, 2nd, 3rd, 4th Year
                </li>
                <li>
                  <strong>Sections:</strong> CSE A, CSE B, CSM, ECE, COS
                </li>
                <li>
                  <strong>Workflow:</strong> Select year and section first, then
                  upload subject data
                </li>
                <li>
                  <strong>Multiple Files:</strong> Teachers can upload multiple
                  files for the same year-section
                </li>
                <li>
                  <strong>Organization:</strong> Each file represents one
                  subject for one year-section combination
                </li>
              </ul>
            </div>
            ...
            <div className="instruction-section">
              ...
              <ul className="instruction-list">
                <li>
                  <strong>Scenario:</strong> Math teacher for 2nd Year CSE A
                  students
                </li>
                <li>
                  <strong>Step 1:</strong> Select "2nd Year" and "CSE A"
                </li>
                <li>
                  <strong>Step 2:</strong> Enter "Mathematics" as subject name
                </li>
                <li>
                  <strong>Step 3:</strong> Choose "Mid-term Exam" as assessment
                  type
                </li>
                <li>
                  <strong>Step 4:</strong> Upload Excel file with student scores
                </li>
                <li>
                  <strong>Result:</strong> Data organized as "Mathematics - Year
                  2 CSEA"
                </li>
              </ul>
            </div>
            ...
            <div className="instruction-section">
              ...
              <ul className="instruction-list">
                ...
                <li>
                  Use consistent data formats (e.g., all scores as numbers)
                </li>
                <li>
                  Save Excel files in .xlsx format for better compatibility
                </li>
